...
public class TestBaseReport {
    ...
    public void setUpTest() {
        ...
        String filePath = System.getProperty("user.dir") + "/test-output/reports.html";
        ...
        extentReports.setSystemInfo("Automation Engineer", "C.ORUC");
        extentHtmlReporter.config().setDocumentTitle("report test");
